...
date = "2026-01-19T17:54:48-06:00"
#dateFormat = "2006-01-02" # This value can be configured for per-post date formatting
author = "arkndjl"
authorTwitter = "ARKNDJL" #do not include @
tags = ["mlb", "statistics"]
keywords = ["prospect", "mlb", "baseball", "2026", "breakout", "chicago"]
description = "Grading the prospects in the Chicago White Sox farm system by Future Value using quantitative and qualitative analysis."
...
Players will be graded on the traditional 20-80 FV scale. For more details on this, see below, and/or [this article](https://blogs.fangraphs.com/the-new-fangraphs-scouting-primer/).
